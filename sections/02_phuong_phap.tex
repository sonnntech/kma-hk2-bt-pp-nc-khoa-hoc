...
pipeline, seed sinh dữ liệu tổng hợp, danh sách kịch bản tampers, logic
verification, tập biến đo lường và thứ tự quy trình. Đồng thời, nghiên
cứu ghi nhận các yếu tố không thể kiểm soát: lập lịch trên nền tảng đám mây, trạng
thái khởi động, cache, độ trễ mạng và việc kịch bản tampers là đại diện gần đúng (proxy)
...
recorder và bộ kiểm chứng vào một Data Pipeline chuẩn. Control
condition phụ thuộc vào câu hỏi nghiên cứu. Đối với detection và
traceability, trạng thái pipeline sạch, không có kịch bản tamper, đóng
...
\hline
H1 & Treatment phát hiện tất cả kịch bản tampers được định nghĩa trước,
...
truy vết. \\
\hline
Số lượng bản ghi & IV thứ bậc & Yếu tố đánh giá scaling của chi phí phát sinh. \\
\hline
Giai đoạn pipeline & IV phân loại & Ngữ cảnh cho block và lineage
mapping. \\
\hline
...
\hline
Overhead bảo mật & DV số & Chi phí thời gian bổ sung của treatment. \\
\hline
\end{tabular}
\end{table}
