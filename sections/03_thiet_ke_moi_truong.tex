...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{images/placeholders/databricks_workspace.pdf}
\caption{Môi trường triển khai thực nghiệm trên Databricks: notebook \texttt{00\_setup\_environment.py} đến \texttt{07\_experiment\_and\_metrics.py} thực thi tuần tự luồng Source--Bronze--Silver--Gold (repo: \url{https://github.com/sonnntech/kma_hk2_chuyen_de_co_so_khoa_hoc}). \emph{Placeholder: sẽ thay bằng ảnh chụp Databricks Workspace thật.}}
