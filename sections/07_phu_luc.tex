...
\item \textbf{Chạy một kịch bản tamper:} \texttt{notebooks/06\_run\_tamper\_scenarios.py} với widget \texttt{SCENARIO = MODIFY\_TRANSACTION\_AMOUNT}, \texttt{CONFIRM\_TAMPER = YES}. Reset bằng \texttt{SCENARIO = RESET\_BASELINE} trước khi đổi scenario khác.
