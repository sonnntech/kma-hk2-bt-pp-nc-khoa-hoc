...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{images/placeholders/verification_dashboard.pdf}
\caption{Kết quả \texttt{verification\_results} cho một clean run (VALID) và một tamper run tiêu biểu, đối chiếu với Bảng~\ref{tab:results}. \emph{Placeholder: sẽ thay bằng ảnh chụp Databricks SQL Dashboard thật.}}
